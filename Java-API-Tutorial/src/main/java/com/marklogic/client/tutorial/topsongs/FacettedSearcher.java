...
// illustrates how to perform facet analysis
public class FacettedSearcher {
	...
	throws JAXBException, URISyntaxException, IOException {
		System.out.println("tutorial: "+FacettedSearcher.class.getName());

		String queryOptionsName = "facetsongs";
	...
	throws JAXBException, URISyntaxException, IOException {
		...
		// support facet constraints on the genre and week range indexes
