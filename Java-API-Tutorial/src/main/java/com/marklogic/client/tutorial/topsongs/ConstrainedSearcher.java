...
// illustrates how to search based on a constraint
public class ConstrainedSearcher {
	...
	throws JAXBException, URISyntaxException, IOException {
		System.out.println("tutorial: "+ConstrainedSearcher.class.getName());
	...
	throws JAXBException, URISyntaxException, IOException {
		...
		// constrain matches on phrases to the artist and writer
		stringQry.setCriteria("artist:\"Aretha Franklin\" AND writer:\"Otis Redding\"");
