...
// illustrates how to search based on key-value criteria
public class KeyValueSearcher {
	...
	throws JAXBException, URISyntaxException, IOException {
		System.out.println("tutorial: "+KeyValueSearcher.class.getName());
		...
		// search criteria of a writer element with the Otis Redding value
		KeyValueQueryDefinition keyValueQry = queryMgr.newKeyValueDefinition();
		keyValueQry.put(
			queryMgr.newElementLocator(new QName("writer")),
			"Otis Redding"
		);
